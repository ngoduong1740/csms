 ...
 * @author DELL
 */
@WebServlet(name="addDrinkServlet", urlPatterns={"/addDrink"})
public class addDrinkServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet addDrinkServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet addDrinkServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
...
//           se.getAttribute("")
        ...
        String redirectURL ="viewDrinks" + "?navbar=drink";
