 ...
 * @author DELL
 */
@WebServlet(name="searchIngredientServlet", urlPatterns={"/searchIngredient"})
public class searchIngredientServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet searchIngredientServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet searchIngredientServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
