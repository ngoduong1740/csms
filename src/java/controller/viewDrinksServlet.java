 ...
 * @author DELL
 */
@WebServlet(name="viewDrinksServlet", urlPatterns={"/viewDrinks"})
public class viewDrinksServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet viewDrinksServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet viewDrinksServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
