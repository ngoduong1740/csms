 ...
 * @author DELL
 */
@WebServlet(name="updateIngredientPerDayServlet", urlPatterns={"/updateIngredientPerDay"})
public class updateIngredientPerDayServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet viewIngredientPerDayServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet viewIngredientPerDayServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
